...
namespace Satrabel.Modules.OpenBlocks
{
    ...
    /// 
    /// Because the control inherits from OpenBlocksSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Block_Settings : OpenBlocksModuleSettingsBase
    {
